...
export const REP_COUNTER_DEFAULT_WINDOW_WIDTH = 90;
export const MIN_EXTECTED_PEAK_PROMINENCE = 50;
...
export const THROTTLE_PUSH_DATA_MS = 10;
export const THROTTLE_ANGLE_CALCULATION_MS = 100;
export const THROTTLE_REP_CALCULATION_MS = 1000;
